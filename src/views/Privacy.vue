<template>
    <main>
        ...
        <p>Tilman Hornung</p>
        <p>E-Mail: mail@tilmanhornung.de</p>
        <p>
        ...
        <p>
            ...
            zu den Servern von YouTube hergestellt. Dabei wird dem YouTube-Server mitgeteilt, welche
        ...
        <p>
            ...
            Cookies gesetzt. Stattdessen werden jedoch sogenannte Local Storage Elemente im Browser des
            Users gespeichert, die &auml;hnlich wie Cookies personenbezogene Daten beinhalten und zur
            Wiedererkennung eingesetzt werden k&ouml;nnen. Details zum erweiterten Datenschutzmodus finden
            Sie hier:
        ...
        <p>
            ...
            Berners House, 47-48 Berners Street, London W1T 3NF, Gro&szlig;britannien.) integriert sein.
        ...
        <p>
            ...
            SoundCloud- Benutzerkonto eingeloggt sind, k&ouml;nnen Sie die Inhalte dieser Website mit
            Ihrem SoundCloud-Profil verlinken und/oder teilen. Dadurch kann SoundCloud Ihrem Benutzerkonto
            den Besuch dieser Website zuordnen. Wir weisen darauf hin, dass wir als Anbieter der Seiten
            keine Kenntnis vom Inhalt der &uuml;bermittelten Daten sowie deren Nutzung durch SoundCloud
            erhalten.
        </p>
        <p>
            ...
            &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff
            auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des
        ...
        <p>
            Weitere Informationen hierzu finden Sie in der Datenschutzerkl&auml;rung von SoundCloud unter:
        ...
        <p>
            ...
            <a href="https://www.spotify.com/de/legal/privacy-policy/" target="_blank"
